...
class ProductTile extends StatelessWidget {
          ...
          showConfirmationDialog(context, product.name, () async {
            ...
            if (orderConfirmed) {
              ...
              if (commandSent) {
                ...
                showBluetoothCommandErrorDialog(context);
              }
            } else {
    ...
    showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          content:
              const Text("Your purchase was successful! Product dispensing..."),
          actions: [
            TextButton(
              onPressed: () {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              const Text("Insufficient balance. Please top up your account."),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(context); // Close the dialog
  ...
  void showBluetoothCommandErrorDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          title: const Text("Machine Communication Error"),
          content: const Text(
            "Payment was processed, but the machine command was not sent. Please reconnect to the vending machine and try again.",
          ),
          actions: [
            TextButton(
              onPressed: () {
