    ...
    return Scaffold(
      ...
      body:  Stack(
         ...
         Padding(
          ...
          child: Column(
            children: [
              Center(child: Image.asset("assets/images/logo.png", height: 200, width: 200,)), // Your Logo
              ...
              CustomTextField(hint: "Enter your email or mobile number", controller: emailController),
              ...
              const SizedBox(height: 5),
              CustomTextField(hint: "******************************", controller: passwordController, isPassword: true),
              ...
              children: [
                ...
                children: [
                  ...
                  const Text("Remember Me", style: TextStyle(color: Color.fromRGBO(215, 215, 215, 0.6))),
                ],
                ),
                TextButton(
                onPressed: () {
              ...
              const SizedBox(height: 10),
              const Text("Don't have an account?", style: TextStyle(color: Color.fromRGBO(215, 215, 215, 0.6))),
              TextButton(onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => SignupView()));
              }, child: const Text("Sign In Now", style: TextStyle(color: Color.fromRGBO(1, 181, 1, 1),))),
              ...
              label: const Padding(
                padding: EdgeInsets.only(left: 20.0), // Add padding to the left of the text
